...
<body>
                ...
                <div class="modal-body">
                    <form action="login.php" method="POST">
                        ...
                        <div class="cance-entrar">
                            <button type="submit" id="cancelar" data-bs-dismiss="modal"
    ...
    <main class="container">
        ...
        <figure class=" itemGaleria  item01">
            <img data-bs-toggle="modal" data-bs-target="#loginModal" src="./Imagens/Everest.jpg" alt="Everest"
                class="imgGaleria">
            <div class="icone">
                <img id="icone" src="./Icones/coração.svg" alt="coração"><span class="numero">0</span>
                <img class="coment" src="./Icones/chat-preto.svg" alt="comentarios"><span class="btn-hearth">0</span>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="cora-curtida">
                        ...
                        <img src="./Icones/chat-preto.svg" alt="chat" id="comentary">
                        <div class="curtida"><span>0</span> </div>
                        <p class="comentarios">comentários</p>
                    </div>
                    <div class="modal-footer">

                        <div class="chat"> <img src="./Icones/chat-preto.svg" id="nuvem" alt="">
                            <div id="texto"><input type="text" name="texto" placeholder="Adicionar comentarios...">
                            </div>
                        </div><img src="./Icones/send.svg" width="50px" alt="">
        ...
        <div class=" galeria">
            <figure class=" itemGaleria  item02">
                <img data-bs-toggle="modal" data-bs-target="#loginModal" src="./Imagens/AlpesSuiços.jpg"
                    alt="lpesSuiços" class="imgGaleria">
                <div class="icone">
                    <img id="icone" src="./Icones/coração.svg" alt="coração"><span class="numero">0</span>
                    <img class="coment" src="./Icones/chat-preto.svg" alt="comentarios"><span class="btn-hearth">0
                    </span>
        ...
        <div class="galeria">
            <figure class=" itemGaleria  item03">
                <img data-bs-toggle="modal" data-bs-target="#loginModal" src="./Imagens/GrandCanyon.jpg"
                    alt="GrandCanyon" class="imgGaleria">
                <div class="icone">
                    <img id="icone" src="./Icones/coração.svg" alt="coração"><span class="numero">0</span>
                    <img class="coment" src="./Icones/chat-preto.svg" alt="comentarios"><span class="btn-hearth">0
                    </span>
        ...
        <div class="galeria">
            <figure class=" itemGaleria  item04">
                <img data-bs-toggle="modal" data-bs-target="#loginModal" src="./Imagens/MonteFuji.jpg" alt="MonteFuji"
                    class="imgGaleria">
                <div class="icone">
                    <img id="icone" src="./Icones/coração.svg" alt="coração"><span class="numero">0</span>
                    <img class="coment" src="./Icones/chat-preto.svg" alt="comentarios"><span class="btn-hearth">0
        ...
        <div class="galeria">
            <figure class=" itemGaleria  item05">
                <img data-bs-toggle="modal" data-bs-target="#loginModal" src="./Imagens/MonteBranco.jpg"
                    alt="MonteBranco" class="imgGaleria">
                <div class="icone">
                    <img id="icone" src="./Icones/coração.svg" alt="coração"><span class="numero">0</span>
                    <img class="coment" src="./Icones/chat-preto.svg" alt="comentarios"><span
                        class="btn-hearth">0</span>
        ...
        <div class=" galeria">
            <figure class=" itemGaleria  item06">
                <img data-bs-toggle="modal" data-bs-target="#loginModal" src="./Imagens/MonteElbrus.jpg"
                    alt="MonteElbrus" class="imgGaleria">
                <div class="icone">
                    <img onclick="" id="icone" src="./Icones/coração.svg" alt="coração"><span class="numero">0</span>
                    <img class="coment" src="./Icones/chat-preto.svg" alt="comentarios"><span class="btn-hearth">0
                    </span>
        ...
        <div class="galeria">
            <figure class=" itemGaleria  item07">
                <img data-bs-toggle="modal" data-bs-target="#loginModal" src="./Imagens/PicoPikes.jpg" alt="PicoPikes"
                    class="imgGaleria">
                <div class="icone">
                    <img onclick="" id="icone" src="./Icones/coração.svg" alt="coração"><span class="numero">0</span>
                    <img class="coment" src="./Icones/chat-preto.svg" alt="comentarios"><span class="btn-hearth">0
        ...
        <div class=" galeria">
            <figure class="itemGaleria  item08">
                <img data-bs-toggle="modal" data-bs-target="#loginModal" src="./Imagens/Huandoy.jpg" alt="Huandoy"
                    class="imgGaleria">
                <div class="icone">
                    <img onclick="" id="icone" src="./Icones/coração.svg" alt="coração"><span class="numero">0</span>
                    <img class="coment" src="./Icones/chat-preto.svg" alt="comentarios"><span class="btn-hearth">0
